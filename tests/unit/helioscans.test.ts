...
describe("helioScansAdapter", () => {
  ...
  it("match handles chapter-like helioscans URLs", () => {
    expect(helioScansAdapter.match("https://helioscans.com/chapter/abc-123/")).toBe(true)
    expect(helioScansAdapter.match("https://helioscans.com/series/abc/12")).toBe(true)
    expect(helioScansAdapter.match("https://example.com/chapter/abc-123/")).toBe(false)
  })
