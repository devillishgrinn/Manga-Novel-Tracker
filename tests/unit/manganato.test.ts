...
describe("manganatoAdapter", () => {
  ...
  it("match detects chapter URLs on both supported domains", () => {
    expect(
      manganatoAdapter.match("https://www.manganato.gg/manga/nano-machine/chapter-299"),
    ).toBe(true);
    expect(
      manganatoAdapter.match("https://www.mangakakalot.gg/manga/nano-machine/chapter_299"),
    ).toBe(true);
