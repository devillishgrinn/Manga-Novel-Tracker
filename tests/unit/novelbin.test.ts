...
describe("novelbinAdapter", () => {
  ...
  it("match detects NovelBin chapter URLs", () => {
    expect(
      novelbinAdapter.match("https://novelbin.com/b/lord-of-the-mysteries/chapter-123-the-next-step"),
    ).toBe(true)
    expect(novelbinAdapter.match("https://www.novelbin.com/b/lord-of-the-mysteries/chapter-12_5")).toBe(true)
